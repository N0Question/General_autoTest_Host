...
V0.81   卫导接收    接收卫导相关数据，分别保存到文件中或追加到惯导中
'''
updating_log = '''
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.setupUi(self)
        self.setWindowTitle("通用自动测试上位机_蔡_功能测试版_2502_V0.81")
...
# --------------------------------全部设置区com口列表---------------------------------------
        ...
        # 十二路开关设置
        for pushbutton in self.combox_com_open_list:
            pushbutton.clicked.connect(self.change_button)
...
# -----------------------------------事件更新计数---------------------------------------
    ...
    def show_message_5s(self):
        ...
        # print('show_msg_:{}'.format(slef.show_timer_count3))
        # 更新串口  #串口更新
    ...
    def read_rules(self):
        ...
        # if True:
            for i in range(len(decode_edia_list)):
                all_rule_length.append(struct.calcsize( decode_edia_list[i]+''.join(decode_rule_list[i]) ))
            print(all_rule_length)
