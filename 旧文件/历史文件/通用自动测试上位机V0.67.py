...
from Automated_testingV11 import Ui_MainWindow
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.setupUi(self)
        self.setWindowTitle("通用自动测试上位机_蔡_功能测试版_2409_V0.67")
    ...
    def show_message_01s(self):
        ...
        cost_time2 = now_time-begin_time
    ...
    def show_message_1s(self):
        ...
        point_lcd_time = time.time()-begin_time_1s
        ...
        if self.auto_plot_always | self.auto_plot_1time:
            ...
            try:
                ...
                plot_data_tab = 0
            point_plot_data_tab = time.time()-begin_time_1s
            # 更新绘图相关设置
            # plot_axis_list = []
            # plot_para_list = []
            # plot_mean_list = []
            ...
            point_plot_axis_time = time.time()-begin_time_1s
            ...
            point_plot_dataframe_time = time.time()-begin_time_1s
            ...
            for i in range(3):
                ...
                try:
                    ...
                    print('绘图报错{}'.format(e))
                    # messagess = '暂无数据'
            point_plot_time = time.time()-begin_time_1s
        ...
        end_time_1s = time.time()
        cost_time_1s = begin_time_1s - end_time_1s
        cost_timess = time.time()
    ...
    def read_rules(self):
        ...
        try:
            ...
            self.textBrowser_automatic_ruleline.append('')
        ...
        for lines in rules.split('\n'):
            ...
            # 判断不合法规则
                ...
                self.textBrowser_automatic_ruleline.append('规则文件错误:{}\n《{}》：《{}》'.format(rule_name,read_line_count,lines))
                continue
    ...
    def threading_receive_data(self,thread_num):
        ...
        while self.threading_test_flag & self.threading_list_flag[thread_num]:
            ...
            if waiting>=decode_fram_leng:
                cache_hex_data = serials.read(waiting)*10
            ...
            if len(all_data)>=decode_fram_leng*2:
                ...
                if frame.startswith(decode_rule_header) & next_frame.startswith(decode_rule_header): 
                    ...
                    if hz_count<receive_hz+1:
                        ...
                        print('保存数据耗时:{:.6f}'.format(save_data_end_time))

                        
                else:
                    all_data = all_data[1:]
                    pop_count+=1
                    print('帧头长度错误 {}'.format(pop_count))
                        
                
                decode_end_time = time.time()-decode_begin_time
                # print('解算耗时:{:.6f}'.format(decode_end_time))
